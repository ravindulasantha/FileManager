<footer class="main-footer bg-white p-3 d-flex">
    ...
    <div class="ms-auto">
        <a href="https://filemanager.veno.it/" target="_blank" title="Current version" style="line-height: 1;">
            <small><?php echo "filemanager43.000webhostapp.com"; ?></small>
        </a>
    </div>
</footer>
...
<script type="text/javascript" src="assets/vfm/js/avatars.js?v=<?php echo "filemanager43.000webhostapp.com"; ?>"></script>
...
<script type="text/javascript" src="admin-panel/js/admin.js?v=<?php echo "filemanager43.000webhostapp.com"; ?>"></script>
